  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item {{ (request()->is('user*')) ? 'active' : '' }} {{ (request()->is('instansi*')) ? 'active' : '' }} {{ (request()->is('rayon*')) ? 'active' : '' }} {{ (request()->is('bukan_pj*')) ? 'active' : '' }}">
        ...
        <div id="collapse0" class="collapse {{ (request()->is('user*')) ? 'show' : '' }} {{ (request()->is('instansi*')) ? 'show' : '' }} {{ (request()->is('rayon*')) ? 'show' : '' }} {{ (request()->is('bukan_pj*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Data User</h6>
            <a class="collapse-item {{ (request()->is('user*')) ? 'active' : '' }}" href="{{url('user')}}">User</a>
            <a class="collapse-item {{ (request()->is('instansi*')) ? 'active' : '' }}" href="{{url('instansi')}}">Instansi</a>
      ...
      <li class="nav-item {{ (request()->is('ruangan*')) ? 'active' : '' }} {{ (request()->is('gedung*')) ? 'active' : '' }}">
        ...
        <div id="collapseTwo" class="collapse  {{ (request()->is('ruangan*')) ? 'show' : '' }} {{ (request()->is('gedung*')) ? 'show' : '' }} " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Data Gedung & Ruangan</h6>
